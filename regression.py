...
if __name__ == "__main__":
    ...
    data.drop(columns=['created_on', 'description', 'operation', 'place_with_parent_names', 'geonames_id', 'currency',
    ...
    '''Small_Test = latLonList_main[:20]
    classify = define_based_on_radius_3(Small_Test, latLonList_cities)
    print("The length of test:",len(Small_Test))
    print("The length of the coordinates:", len(latLonList_cities))
    print(len(classify))'''
